export function CardBody({ d, card_dim, card_display }) {
  return {
    ...
    <g class="card-body">
      ...
      <g transform="translate(${card_dim.text_x}, ${0})">
        <text clip-path="url(#card_text_clip)">

      <tspan x="${0}" dy="${14}" font-size="10">${card_display[0](
      d.data
    )}</tspan>
      ...
      d.data
         ...
         <tspan x="${0}" dy="${14}" font-size="10">${card_display[2](
      d.data
    )}</tspan>
    </tspan>

         <tspan x="${0}" dy="${14}" font-size="10">${card_display[3](
      d.data
    )}</tspan>
        </text>
  ...
  function GenderlessIcon() {
    return `
      <g class="genderless-icon">
        <rect height="${card_dim.img_h}" width="${
      card_dim.img_w
    }" fill="rgb(59, 85, 96)" />
